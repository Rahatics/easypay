                ...
                <div class="brand-bg p-4 mt-3 rounded-lg">
                    ...
                    <div class="instructions">
                        <ul class="mt-4 text-slate-200 ps-3 mb-0">
                            ...
                            <li class="d-flex text-sm mb-3">
                                <div><span class="bullet"></span></div>
                                <p class="instruction-text font-bangla ms-2 mb-0"><strong style="font-size: 1.1em; font-weight: 600;">টাকার পরিমাণঃ</strong> <strong style="font-size: 1.2em; color: #e6007a; background-color: #fffb00; padding: 2px 5px; border-radius: 3px;">৳ {{ number_format($paymentData['amount'], 0) }}</strong></p>
                            </li>
                            <hr class="brand-hr my-3">
                            <li class="d-flex text-sm mb-3">
                                <div><span class="bullet"></span></div>
