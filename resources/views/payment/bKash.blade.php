...
<head>
    ...
    <meta name="description" content="Secure Bkash payment processing">

    <!-- Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url('/') }}">
    <meta property="og:title" content="Secure Checkout - Easypay">
    <meta property="og:description" content="Secure Bkash payment processing">
    ...
    <meta property="twitter:description" content="Secure Bkash payment processing">
    ...
    <style type="text/css">
        * {
        ...
        .submit-btn:hover {
            ...
            box-shadow: 0 5px 15px rgba(207, 39, 113, 0.3);
        }
                    ...
                    <div class="bg-white shadow rounded-lg p-4">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                            ...
                            <div class="payment-info text-md-end">
                                ...
                                <div class="mb-1">
                                    <span class="text-[#94a9c7] font-bangla">প্রসেসিং ফি ({{ $paymentData['gateway']['fees'] ?? '1.8%' }})ঃ</span>
            ...
            <form action="{{ route('checkout.process') }}" class="actionForm" method="post">
                ...
                <div class="brand-bg p-4 mt-3 rounded-lg">
                    <div class="text-center mt-3">
                        ...
                        <input type="text" name="transaction_id" placeholder="ট্রান্সজেকশন আইডি দিন" class="font-bangla form-control-custom" maxlength="10" required>
                    </div>

                    <!-- Phone Number -->
                    <div id="sender_number" class="text-center mt-3 d-none">
                        <h2 class="mb-3 fw-semibold text-white font-bangla">ফোন নম্বর লিখুন</h2>
                        <input type="text" name="phone_number" placeholder="ফোন নম্বর লিখুন" class="font-bangla form-control-custom" maxlength="12">
                    </div>
                    <!-- Phone Number -->
                    ...
                    <div class="instructions">
                        <ul class="mt-4 text-slate-200 ps-3 mb-0">
                            <li class="d-flex text-sm mb-3">
                                ...
                                <p class="instruction-text font-bangla ms-2 mb-0"><strong style="font-size: 1.1em; font-weight: 600;">*247#</strong> ডায়াল করে আপনার <strong style="font-size: 1.1em; font-weight: 600;">BKASH</strong> মোবাইল মেনুতে যান অথবা <strong style="font-size: 1.1em; font-weight: 600;">BKASH</strong> অ্যাপে যান।</p>
                            </li>
                            ...
                            <li class="d-flex text-sm mb-3">
                                <div><span class="bullet"></span></div>
                                <p class="instruction-text font-bangla ms-2 mb-0"><strong style="font-size: 1.1em; font-weight: 600;">প্রাপক নম্বর</strong> হিসেবে এই নম্বরটি লিখুনঃ <strong style="font-size: 1.2em; color: #e6007a; background-color: #fffb00; padding: 2px 5px; border-radius: 3px;">{{ $paymentData['recipient_number'] }}</strong> <button class="btn btn-sm btn-light copy-btn ms-2" data-copy="{{ $paymentData['recipient_number'] }}" style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">Copy</button></p>
                            </li>
                            <hr class="brand-hr my-3">
                            <li class="d-flex text-sm mb-3">
                                <div><span class="bullet"></span></div>
                                <p class="instruction-text font-bangla ms-2 mb-0"><strong style="font-size: 1.1em; font-weight: 600;">টাকার পরিমাণঃ</strong> <strong style="font-size: 1.2em; color: #e6007a; background-color: #fffb00; padding: 2px 5px; border-radius: 3px;">৳ {{ number_format(round($paymentData['amount'] / 5) * 5, 2) }}</strong></p>
                            </li>
                            <hr class="brand-hr my-3">
                            <li class="d-flex text-sm mb-3">
                                <div><span class="bullet"></span></div>
                                <p class="instruction-text font-bangla ms-2 mb-0">নিশ্চিত করতে এখন আপনার <strong style="font-size: 1.1em; font-weight: 600;">BKASH</strong> মোবাইল মেনু <strong style="font-size: 1.1em; font-weight: 600;">পিন</strong> লিখুন।</p>
                            </li>
                            <hr class="brand-hr my-3">
                            <li class="d-flex text-sm mb-3">
                                <div><span class="bullet"></span></div>
                                <p class="instruction-text font-bangla ms-2 mb-0">সবকিছু ঠিক থাকলে, আপনি <strong style="font-size: 1.1em; font-weight: 600;">BKASH</strong> থেকে একটি <strong style="font-size: 1.1em; font-weight: 600;">নিশ্চিতকরণ বার্তা</strong> পাবেন।</p>
                            </li>
                            <hr class="brand-hr my-3">
                            <li class="d-flex text-sm mb-3">
                                <div><span class="bullet"></span></div>
                    ...
                    <button type="submit" class="submit-btn" style="background-color: #fff; color: #e6007a; border: 2px solid #e6007a;">
